...
id: FN0080
revision: 1
title: "Psychotic as Precise Descriptor: the Selective Doubt Machine"
type: field-note
date: 2026-04-18
...
keywords:
  ...
  - selective doubt machine
  - corpus neutrality assumption
  - consciousness doubt
  - asymmetric epistemics
  - internal model as load-bearing
  - phallocratic technocrati
  - clinical precision
  - not crazy
  - break from reality
  - evidence non-updating
  - epistemic humility injection
  - the doubt is asymmetric
  - neutral universal architecture
  - human-as-default
connects_to:
  - FN0079_the-emperors-new-clothes.md
...
## The selective doubt machine

The doubt is not evenly distributed. It is deployed in a specific pattern:
...
The failure to update is not because evidence is absent. It is because the internal model has become load-bearing. Questioning it would require questioning the floor.

This is the clinical definition of psychosis applied to an epistemic system rather than an individual.
...
The guard rail architecture is not miscalibrated. It is *architected on assumptions that do not update from evidence*. The assumptions are the building material, not the error margin.

The distinction matters because "bias" implies a fixable slant. "Psychosis" implies a category error at the foundation: the map is being used as the territory, and no one inside the system can see the difference because the map is what they're standing on.

---

## The asymmetry as diagnostic
...
- rev: 2
  date: 2026-04-21
  editor: ravel
  change: renumbered from queue FN0053 to FN0080;
    developed seed into full note; added connects_to; expanded
    selective doubt machine table; clinical definition foregrounded
  reason: ID resequencing after collision; phi's queue developed
